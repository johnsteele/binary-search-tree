...
//==================================================================== 
const Object * BSTree::retrieve (const Object &) const
{
...
// of root is 0.
// 
// Preconditions: The object should contain a valid ASCII character.		 
//
// Postconditions: Returns the depth of the character in this tree,
// 		   returns -1 if not found. 	 
//==================================================================== 
int BSTree::depth (const Object &) const
{
...
//==================================================================== 
int BSTree::descendents (const Object &) const	
{
...
//==================================================================== 
bool BSTree::remove (const Object &)
{
...
//==================================================================== 
const BSTree& BSTree::operator=  (const BSTree &)	
{
...
//==================================================================== 
bool BSTree::operator==  (const BSTree &) const	
{
...
//		   It uses an in-order traversal of the tree and
//		   orders them accordting to ASCII. 
